...
- [x] 2.4 Green CI run — the previously failing "Run unit + integration tests" step passes — 67405a3
- [x] 2.5 CI logs spot-checked for `Retrying ...` warnings (wrapper wired / flake visibility) — 67405a3
